        ...
        <div className="card-no-blur p-8 sm:p-10">
          ...
          <div className="mt-4 grid grid-cols-1 gap-4">
            <label className="flex flex-col">
              ...
              <div className="skeleton-glow h-[146px] rounded-2xl border border-[#E8DDC9] bg-white px-4 py-3 text-[#A24E69]" />
            </label>
          </div>
          <div className="mt-8 px-6 sm:px-0 flex flex-wrap items-center gap-3 justify-center sm:justify-start">
            <div className="skeleton-glow inline-flex w-full sm:w-auto items-center justify-center rounded-2xl border border-[#843E55] bg-[#A24E69] px-6 py-3 font-medium shadow">
              Submit RSVP
            </div>
