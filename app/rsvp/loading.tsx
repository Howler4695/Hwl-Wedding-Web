      ...
      <section className="relative z-10 w-full max-w-2xl">
        <div className="card p-10">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="skeleton-glow inline-flex items-center text-center justify-center rounded-2xl border border-[#843E55] bg-[#A24E69] px-6 py-3 font-medium shadow transition-transform hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-[#CAA55A] focus-visible:ring-offset-2">
              {"Edit RSVP"}
            </div>
